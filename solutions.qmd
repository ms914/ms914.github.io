...
| **2(b)** | **Partikulär:** Finde $x_p$ mit $Ax_p=-b$ (wobei $b=(1,0)^T$). <br> Lösen: $3x-y=-1$ und $5x-y=0$ ⇒ $x=\frac{1}{2}$, $y=\frac{5}{2}$. <br> Somit: $x_p=\begin{pmatrix}\frac{1}{2}\\\frac{5}{2}\end{pmatrix}$. <br> **Allgemeine Lösung:** $x(t)=c_1\,x_1(t)+c_2\,x_2(t)+x_p$. <> in Matrixform; $X=\begin{pmatrix}x_1(t)&&x_2(t)\end{pmatrix}\begin{pmatrix}c_1\\c_2\end{pmatrix}=\begin{pmatrix}\cos(t)&&\sin(t)\\a_2\cos(t)-b_2\sin(t)&&a_2\sin(t)+b_2\cos(t)\end{pmatrix}\begin{pmatrix}c_1\\c_2\end{pmatrix} +\begin{pmatrix}\frac{1}{2}\\\frac{5}{2}\end{pmatrix}$. |
